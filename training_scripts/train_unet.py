...
if __name__ ==  '__main__':
    ...
    modelname    = 'trial'
    modelname    = 'with_L2_loss_no_batchnorm'
    ...
    modelname       = 'PILoss_scaled_optimised_bc'
    trainloss_class = PhysicsLoss(loss_param_dict = {'loss'         : nn.MSELoss(reduction = 'sum'),
                                                     'a_div'        : 0.040728514188668685, #0.05558006642313271, # 0.002467372268031178, # 0.013187661483418931
                                                     'a_ns'         : 0.040728514188668685, #0.05558006642313271, # 0.002467372268031178, # 0.013187661483418931
                                                     'a_bc'         : 0.040728514188668685, #0.05558006642313271, # 0.002467372268031178, # 0.013187661483418931
                                                     'scale_base'   : 0.3e6,
                                                     'scale_div'    : 1e-5,
                                                     'scale_ns'     : 0.01,
                                                     'scale_bc'     : 1,
